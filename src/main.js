require(['Phaser', 'LowRez'], function (Phaser, LowRez) {

    'use strict';

    var game = new Phaser.Game(512, 288, Phaser.CANVAS, 'game', { preload: preload, create: create, update: update });
    ...
    function create() {
        ...
        sprite = game.add.sprite(128, 550, 'phaser');
